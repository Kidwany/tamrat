...
@section('content')
    ...
    <div class="body_scroll">
            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">تعديل الرمز</li>
                    </ul>
        ...
        <div class="container-fluid">
            ...
            <!-- Vertical Layout -->
            <form action="{{route('promo-code.update', $code->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('patch')
                            ...
                            <div class="body">
                                <div class="row">
                                    <div class="col-lg-6 col-md-12 col-sm-3">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="code" value="{{$code->code}}" id="email_address" class="form-control" placeholder="ادخل الكود الترويجي" required >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-3">
                                        ...
                                        <div class="form-group">
                                            <input type="date" name="expire" value="{{$code->expire_date->format("Y-m-d")}}" step="any" id="email_address" class="form-control" placeholder="ادخل وصف الإشعار" required >
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-12 col-sm-3 amount discount-input">
                                        ...
                                        <div class="form-group">
                                            <input type="number" name="amount" value="{{$code->amount}}" step="any" id="email_address" class="form-control" placeholder="ادخل قيمة الخصم من اجمالي قيمة الطلب مثال: 50 ريال " >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-3 delivery discount-input">
                                        ...
                                        <div class="form-group">
                                            <input type="number" name="delivery" value="{{$code->delivery}}" id="email_address" class="form-control" placeholder="ادخل قيمة التوصيل اثناء الخصم" >
