                ...
                <div class="row">
                    <div class="col-lg-4 col-sm-12">
                        <form class="card auth_form" action="{{route('login')}}" method="post">
                            @csrf
                            <div class="header">
                                <img class="logo" src="{{assetPath('dashboard/assets/images/logo-3.png')}}" alt="" style="height: 150px; width: auto">
                                <h5> تسجيل الدخول</h5>
                            </div>
                            <div class="body">
                        ...
                        <div class="copyright text-center">
                            ...
                            <span>جميع الحقوق محفوظة <a href="#" target="_blank">تمرات</a></span>
                        </div>
                    </div>
