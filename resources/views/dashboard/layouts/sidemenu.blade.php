...
<aside id="leftsidebar" class="sidebar">
    ...
    <div class="menu">
        <ul class="list">
            ...
            <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-accounts"></i><span>المستخدمين </span></a>
                <ul class="ml-menu">
                    <li><a href="{{adminUrl('user')}}">شاهد المستخدمين</a></li>
                   {{-- <li><a href="{{adminUrl('user/create')}}">مستخدم جديد</a></li>--}}
                </ul>
            </li>
            <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-shopping-basket"></i><span>المنتجات</span></a>
                <ul class="ml-menu">
                    <li><a href="{{adminUrl('product')}}">شاهد المنتجات</a></li>
                    <li><a href="{{adminUrl('product/create')}}"> منتج جديد</a></li>
                </ul>
            </li>
            <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-shopping-cart-plus"></i><span>الطلبات</span></a>
                <ul class="ml-menu">
            ...
            <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-notifications"></i><span>الإشعارات</span></a>
                <ul class="ml-menu">
