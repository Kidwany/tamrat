                            ...
                            <div class="body">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-3">
                                        <label for="email_address">اسم المنتج</label>
                                        <div class="form-group">
                                            <input type="text" name="name_en" value="{{old('name_en')}}" id="email_address" class="form-control" placeholder="ادخل اسم المنتج">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-3">
                                        <label for="email_address">وصف المنتج</label>
                                        <div class="form-group">
                                            <input type="text" name="desc_en" value="{{old('desc_en')}}" id="email_address" class="form-control" placeholder="ادخل وصفا دقيقا للمنتج">
                                        </div>
                                    </div>
                                </div>
                            </div>
